...
import { A as A$1 } from './button-BUb5ee2-.mjs';
...
function A() {
  ...
  return ssr(p, ssrHydrationKey(), escape(createComponent(q, {})), escape(createComponent(E, {})), escape(createComponent(A$1, { children: "Create Agent" })), escape(createComponent(A$1, { get variant() {
