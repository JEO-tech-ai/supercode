...
import { u as u$1, h, g, p, m } from './card-xYJnUqvS.mjs';
import { q, E, i } from './sidebar-lSzgpHq7.mjs';
import { f } from './protected-route-M6OqgFP0.mjs';
...
function j() {
  ...
  return createComponent(f, { get children() {
    return ssr(C, ssrHydrationKey(), escape(createComponent(q, {})), escape(createComponent(E, {})), escape(createComponent(i, { href: "/settings/api-keys", get children() {
