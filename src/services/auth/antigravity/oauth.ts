 ...
 * @param clientId - OAuth client ID (defaults to ANTIGRAVITY_CLIENT_ID)
 * @param port - Callback server port (defaults to ANTIGRAVITY_CALLBACK_PORT)
...
/**
 * Callback server handle for OAuth flow.
 */
 ...
 * @returns Callback server handle
 */
 ...
 *
 * @param projectId - Optional GCP project ID
 * @param openBrowser - Function to open browser with auth URL
 * @param clientId - OAuth client ID
 * @param clientSecret - OAuth client secret
 * @returns Tokens, user info, and PKCE verifier
 */
